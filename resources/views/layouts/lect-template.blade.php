...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('lecturerprofile.edit')}}">
            ...
            <!-- Nav Item - Resume -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('studResume.index')}}">
           ...
           <!-- Nav Item - Resume -->
           <li class="nav-item">
               <a class="nav-link" href="{{route('allCompanies.index')}}">
                   <i class="fas fa-fw fa-table"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{route('lecturerprofile.edit')}}">
